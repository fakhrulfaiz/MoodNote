...
public class MainActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_NOTE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            int mood = Integer.parseInt(Objects.requireNonNull(data.getStringExtra(AddNoteActivity.ExtraMood)));
            boolean daynight = Boolean.parseBoolean(data.getStringExtra(AddNoteActivity.ExtraDayNight));
            MoodNote note = new MoodNote(Objects.requireNonNull(data.getStringExtra(AddNoteActivity.ExtraDate)), mood,
